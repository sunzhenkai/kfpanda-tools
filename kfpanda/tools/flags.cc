...
DEFINE_string(service, "KungFuPandaServer", "service");
DEFINE_int32(count, 1, "count");
DEFINE_string(target, "127.0.0.1:9820", "target base (host:port)");
...
DEFINE_string(filter, "", "xpath filter regrex");
DEFINE_string(ignore, "", "ignored xpath regrex");
